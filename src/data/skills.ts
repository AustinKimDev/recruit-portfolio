...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Supabase / Realtime", evidence: lt("MateYou timesheet의 출근 상태, 승인 요청, 감사 로그, 실시간 출근자 현황", "MateYou timesheet status, approval requests, audit logs, and realtime working partner views") },
